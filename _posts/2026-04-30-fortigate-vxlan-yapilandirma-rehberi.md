Dosya adından başlayarak, içeriğin tamamını GitHub'da yeni bir dosya oluşturup direkt yapıştırabileceğin şekilde tek bir kod bloğunda hazırladım.

**Dosya Adı:** `2026-04-30-fortigate-vxlan-yapilandirma-rehberi.md`
